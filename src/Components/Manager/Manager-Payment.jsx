            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              ...
              <div className="bg-white p-4 rounded-lg">
                <div className="flex items-center gap-2">
                  <div className="w-12 h-12 bg-yellow-100 rounded-full flex items-center justify-center text-yellow-600">$</div>
                ...
                <tbody>
                  {
                    <tr className="border-b">
                      <td className="p-4"><Link to={`/manager/vender/payment/detail/:id`}>{wallet._id }</Link></td>
